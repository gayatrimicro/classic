(function() {
    ...
    function(e) {
        ...
        function r(e, n) {
            ...
            function a(e) { this.src = e, h[e] = this } r.prototype = new e, r.prototype.options = {}, r.prototype.getImages = function() { this.images = []; for (var e = 0, t = this.elements.length; t > e; e++) { var n = this.elements[e]; "IMG" === n.nodeName && this.addImage(n); for (var i = n.querySelectorAll("img"), r = 0, o = i.length; o > r; r++) { var s = i[r];
...
(function($, window, document) {
    ...
    jQuery(document).ready(function($) {
        ...
        /****************header and footer******************/
        var header_content = `<div class="nectar" id="search-outer">
				        ...
				        <div class="container">
				            <div class="row">
				                ...
				                <div class="col span_3">
				                    <a href="/" id="logo"><img alt="Classic-logo" class="stnd default-logo dark-version" src="https://s3.ap-south-1.amazonaws.com/gwsprojects/websites/classic/assets/images/logo.png"><img alt="Classic-logo" class="retina-logo dark-version" src="https://s3.ap-south-1.amazonaws.com/gwsprojects/websites/classic/assets/images/logo.png"><img alt="" class="starting-logo default-logo" src="https://s3.ap-south-1.amazonaws.com/gwsprojects/websites/classic/assets/images/logo.svg"> <img alt="Classic-logo" class="retina-logo starting-logo" src="https://s3.ap-south-1.amazonaws.com/gwsprojects/websites/classic/assets/images/logo.svg"></a>
				                </div>
				                <!--/span_3-->
				                <div class="col span_9 col_last">
				                    <div class="slide-out-widget-area-toggle mobile-icon std-menu fullscreen" data-icon-animation="simple-transform">
				                        <div>
				                            <a class="closed" href="#sidewidgetarea" id="toggle-nav"><span><i class="lines-button x2"><i class="lines"></i></i></span></a>
				                        </div>
				                    </div>
				                    <nav>
				                        ...
				                        <ul class="sf-menu">
				                            <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home page_item page-item-5  menu-item-6761" id="menu-item-6761">
				                                <a href="/">Home</a>
				                            </li>
				                            <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children sf-with-ul menu-item-6904" id="menu-item-6904">
				                                <a href="/about/">About us<span class="sf-sub-indicator"><i class="icon-angle-down"></i></span></a>
				                                <ul class="sub-menu">
				                                    <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-6905" id="menu-item-6905">
				                                        <a href="/about/">Company Profile</a>
				                                    </li>
                                                    <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-6905" id="menu-item-6905">
                                                        <a href="/about#leader">Leadership</a>
                                                    </li>
				                                    <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-6905" id="menu-item-6905">
				                                        <a href="/about#history">History</a>
				                                    </li>
				                                    <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-6907" id="menu-item-6907">
				                                        <a href="/about#vision">Vision & Mission</a>
				                                    </li>
				                                    <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-6908" id="menu-item-6908">
				                                        <a href="/about#values">Company Values</a>
				                                    </li>
				                                    <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-6910" id="menu-item-6910">
				                                        <a href="/about#forth">Certificates</a>
				                                    </li>
				                                    <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-6911" id="menu-item-6911">
				                                        <a href="/about#brochures">Brochures</a>
				                                    </li>
				                                    
				                                </ul>
				                            </li>
				                            <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-9688" id="menu-item-9688" style="margin-left:-10px;">
				                                <a href="#">Plant Overview<span class="sf-sub-indicator"><i class="icon-angle-down"></i></span></a>
				                              
				                                <ul class="sub-menu">
				                                 <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-6909" id="menu-item-6909">
				                                        <a href="/overview/drywall-screws/">Drywall Screws</a>
				                                    </li>
				                                     <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-6910" id="menu-item-6910">
				                                        <a href="/overview/hex-head-bolts/">Hex Head Bolts</a>
				                                    </li>                                    
				                                    <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-6905" id="menu-item-6905">
				                                        <a href="/overview/anchor-bolt-stud-bolt-machineries/">Anchor & Stud Bolts</a>
				                                    </li>
				                                       <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-6908" id="menu-item-6908">
				                                        <a href="/overview/quality-control/">Quality Control </a>
				                                    </li>
				                                     <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-6905" id="menu-item-6905">
				                                        <a href="/overview/coating-plants/">Coating Plant</a>
				                                    </li>
				                                   
				                                </ul>
				                            </li>
				                            <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children sf-with-ul menu-item-6904" id="menu-item-2210">
				                                <a href="#">Products<span class="sf-sub-indicator"><i class="icon-angle-down"></i></span></a>
				                                <ul class="sub-menu">
				                                 <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-6909" id="menu-item-6909">
				                                        <a href="/product/hex-bolts/">Hex Bolts</a>
				                                    </li>
				                                     <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-6910" id="menu-item-6910">
				                                        <a href="/product/socket-screws/">Socket Screws</a>
				                                    </li>                                    
				                                    <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-6905" id="menu-item-6905">
				                                        <a href="/product/drywall-screws/"> Drywall Screws</a>
				                                    </li>
				                                       <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-6908" id="menu-item-6908">
				                                        <a href="/product/anchor-bolts/">Anchor Bolts</a>
				                                    </li>
				                                     <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-6905" id="menu-item-6905">
				                                        <a href="/product/stud-bolts/">Stud Bolts</a>
				                                    </li>
                                                    <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-6905" id="menu-item-6905">
                                                        <a href="/product/dowel-bar/">Dowel Bar</a>
                                                    </li>
				                                    <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-6907" id="menu-item-6907">
				                                        <a href="/product/threaded-rods/">Threaded Rods</a>
				                                    </li>
				                                    <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-6911" id="menu-item-6911">
				                                        <a href="/product/nuts/">Nuts</a>
				                                    </li>
				                                    <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-6923" id="menu-item-6923">
				                                        <a href="/product/washers/">Washers</a>
				                                    </li>
				                                </ul>
				                            </li>
				                         
				                                    <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-6767" id="menu-item-6767" style="margin-left:-10px;">
				                                <a href="/contact#fws_5926c196362e1">Careers</a></li>
				                            <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-6767" id="menu-item-6767" style="margin-left:0px;">
        ...
        document.getElementById('header-outer').innerHTML = header_content;
        var mobile_header_content = `<div class="container">
							    <ul>
							        <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-5  menu-item-6761" id="menu-item-6761">
							            <a href="/">Home</a>
							        </li>
							        <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children sf-with-ul menu-item-6904" id="menu-item-6904">
							            <a href="/about/">About us<span class="sf-sub-indicator"><i class="icon-angle-down"></i></span></a>
							        ...
							        <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-9688" id="menu-item-9688">
							            <a href="#">Plant Overview</a>
							            <ul class="sub-menu">
				                                 <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-6909" id="menu-item-6909">
				                                        <a href="/overview/drywall-screws/">Drywall Screws</a>
				                                    </li>
                                    ...
                                    <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-6923" id="menu-item-6923">
                                                <a href="/contact#fws_5926c196362e1">Careers</a>
                                            </li>
							        <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-6767" id="menu-item-6767">
							            <a href="/contact/">Contact</a>
							        </li>
							        <li id="mobile-search">
							            <form action="#" method="get">
        ...
        document.getElementById('mobile-menu').innerHTML = mobile_header_content;
        var footer_content = `<div id="footer-widgets">
				        <div class="container-fulid">
				            <div class="row">
				                <div class="col span_2" id="foot_sp">
				                    <div class="widget widget_text" id="text-2">
				                        <h4>Address:</h4>
				                        <div class="textwidget">
				                     CLASSIC METALLIC SHEETS FACTORY LLC
				                            <p>Emirates Industrial City,<br>  Sector 7, Plot No: 64,

                                                   <br>Al Sajaa Industrial Area, <br>P.O Box 5841,

                                                         Sharjah,  <br>United Arab Emirates
				               ...
				               <div class="col span_2" id="foot_sp">
				                    <div class="widget widget_text" id="text-3">
				                        ...
				                        <div class="textwidget">
				                          Phone: +971 6 575 1335<br>
				                                Fax: + 971 6 534 7298 
				                                <br> <a href="mailto:sales@clmet.com">E-mail : sales@clmet.com</a> / <a href="mailto:info@clmet.com"> info@clmet.com</a><br>
				    ...
				    <div class="row" id="copyright">
				        <div class="container">
				              ...
				              <div class="col span_6">
				                     ...
				                     <a href="/contact/">
				                        <font color="white" size="3">Contact us</font> 
				                    </a>
				                       <a href="/sitemap/">
				                        <font color="white" size="3">&nbsp; | &nbsp; Sitemap &nbsp;</font>
				                    </a>
				                      <a href="/terms-and-conditions/">
				                        <font color="white" size="3"> | &nbsp; Terms and Conditions &nbsp;</font>
				                    </a>
				                     <a href="/privacy-policy/">
				                        <font color="white" size="3"> | &nbsp; Privacy Policy</font>
				                    </a>
				                     </p>
        ...
        document.getElementById('footer-outer').innerHTML = footer_content;
        /***************** Pretty Photo ******************/
        ...
        (function(k) { k.transit = { version: "0.9.9", propertyMap: { marginLeft: "margin", marginRight: "margin", marginBottom: "margin", marginTop: "margin", paddingLeft: "padding", paddingRight: "padding", paddingBottom: "padding", paddingTop: "padding" }, enabled: true, useTransitionEnd: false }; var d = document.createElement("div"); var q = {};
            ...
            q.transform3d = e(); var i = { transition: "transitionEnd", MozTransition: "transitionend", OTransition: "oTransitionEnd", WebkitTransition: "webkitTransitionEnd", msTransition: "MSTransitionEnd" }; var f = q.transitionEnd = i[q.transition] || null; for (var p in q) { if (q.hasOwnProperty(p) && typeof k.support[p] === "undefined") { k.support[p] = q[p] } } d = null;
            ...
            k.cssHooks["transit:transform"] = { get: function(r) { return k(r).data("transform") || new j() }, set: function(s, r) { var t = r; if (!(t instanceof j)) { t = new j(t) } if (q.transform === "WebkitTransform" && !a) { s.style[q.transform] = t.toString(true) } else { s.style[q.transform] = t.toString() } k(s).data("transform", t) } };
            k.cssHooks.transform = { set: k.cssHooks["transit:transform"].set }; if (k.fn.jquery < "1.8") { k.cssHooks.transformOrigin = { get: function(r) { return r.style[q.transformOrigin] }, set: function(r, s) { r.style[q.transformOrigin] = s } };
                k.cssHooks.transition = { get: function(r) { return r.style[q.transition] }, set: function(r, s) { r.style[q.transition] = s } } } n("scale");
            n("translate");
            n("rotate");
            n("rotateX");
            n("rotateY");
            ...
            function j(r) { if (typeof r === "string") { this.parse(r) } return this } j.prototype = { setFromString: function(t, s) { var r = (typeof s === "string") ? s.split(",") : (s.constructor === Array) ? s : [s];
                    r.unshift(t);
            ...
            function g(s, v, x, r) { var t = h(s); if (k.cssEase[x]) { x = k.cssEase[x] } var w = "" + l(v) + " " + x; if (parseInt(r, 10) > 0) { w += " " + l(r) } var u = [];
                k.each(t, function(z, y) { u.push(y + " " + w) }); return u.join(", ") } k.fn.transition = k.fn.transit = function(z, s, y, C) { var D = this; var u = 0; var w = true; if (typeof s === "function") { C = s;
                    ...
                    delete z.delay } if (typeof s === "undefined") { s = k.fx.speeds._default } if (typeof y === "undefined") { y = k.cssEase._default } s = l(s); var E = g(z, s, y, u); var B = k.transit.enabled && q.transition; var t = B ? (parseInt(s, 10) + parseInt(u, 10)) : 0; if (t === 0) { var A = function(F) { D.css(z); if (C) { C.apply(D) } if (F) { F() } };
                    m(D, w, A); return D } var x = {}; var r = function(H) { var G = false; var F = function() { if (G) { D.unbind(f, F) } if (t > 0) { D.each(function() { this.style[q.transition] = (x[this] || null) }) } if (typeof C === "function") { C.apply(D) } if (typeof H === "function") { H() } }; if ((t > 0) && (f) && (k.transit.useTransitionEnd)) { G = true;
                        D.bind(f, F) } else { window.setTimeout(F, t) } D.each(function() { if (t > 0) { this.style[q.transition] = E } k(this).css(z) }) }; var v = function(F) { this.offsetWidth;
                    r(F) };
                m(D, w, v); return this };

            function n(s, r) { if (!r) { k.cssNumber[s] = true } k.transit.propertyMap[s] = q.transform;
            ...
            function l(s) { var r = s; if (k.fx.speeds[r]) { r = k.fx.speeds[r] } return o(r, "ms") } k.transit.getTransitionValue = g })(jQuery);
            ...
            ! function() {
                ...
                function t() { if (document.body) { var t = document.body,
                            ...
                            r = t.scrollHeight; if (S = document.compatMode.indexOf("CSS") >= 0 ? n : t, w = t, e(), x = !0, top != self) y = !0;
                                ...
                                l.style.clear = "both", t.appendChild(l) } } v.fixedBackground || b || (t.style.backgroundAttachment = "scroll", n.style.backgroundAttachment = "scroll") } }

                function n(e, t, n, o) { if (o || (o = 1e3), d(t, n), 1 != v.accelerationMax) { var r = +new Date,
                            a = r - C; if (a < v.accelerationDelta) { var i = (1 + 30 / a) / 2;
                            i > 1 && (i = Math.min(i, v.accelerationMax), t *= i, n *= i) } C = +new Date } if (M.push({ x: t, y: n, lastX: 0 > t ? .99 : -.99, lastY: 0 > n ? .99 : -.99, start: +new Date }), !T) { var l = e === document.body,
                            u = function() { for (var r = +new Date, a = 0, i = 0, c = 0; c < M.length; c++) { var s = M[c],
                                    ...
                                    v.pulseAlgorithm && (h = p(h)); var m = s.x * h - s.lastX >> 0,
                                        w = s.y * h - s.lastY >> 0;
                                    a += m, i += w, s.lastX += m, s.lastY += w, f && (M.splice(c, 1), c--) } l ? window.scrollBy(a, i) : (a && (e.scrollLeft += a), i && (e.scrollTop += i)), t || n || (M = []), M.length ? N(u, e, o / v.frameRate + 1) : T = !1 };
                        N(u, e, 0), T = !0 } }
                ...
                function r(e) { var t = e.target,
                        ...
                        case H.right:
                            a = v.arrowScroll; break;
                        default:
                            return !0 } n(u, a, i), e.preventDefault() }
	   ...
	   $('#page-header-bg[data-parallax="1"] #portfolio-filters').css({ 
        ...
        function nectarBoxRollContentHeight() {
            ...
            if ($('#header-outer[data-transparent-header="true"]').length == 0) {
                ...
                if ($('.mobile').length == 0) { $('#ajax-content-wrap').css('margin-top', $('#header-space').height());
                    $('#slide-out-widget-area.fullscreen').css('margin-top', '-' + $('#header-space').height() + 'px'); } else $('#ajax-content-wrap, #slide-out-widget-area.fullscreen').css('margin-top', '0');
            } else {
        ...
        if ($('body[data-ajax-transitions="true"]').length > 0 && $('#ajax-loading-screen[data-method="ajax"]').length > 0 && !navigator.userAgent.match(/(Android|iPod|iPhone|iPad|BlackBerry|IEMobile|Opera Mini)/) && $(window).width() > 690) {
            ...
            if ($('#ajax-loading-screen[data-effect="standard"]').length > 0) {
                if ($('.nectar-particles').length == 0) setTimeout(function() { $('#ajax-loading-screen').stop().transition({ 'opacity': 0 }, 800, function() { $(this).css({ 'display': 'none' }); });
                    $('#ajax-loading-screen .loading-icon').transition({ 'opacity': 0 }, 800) }, 100);
 ...
 */
(function(e) { e.fn.hoverIntent = function(t, n, r) { var i = { interval: 100, sensitivity: 7, timeout: 0 }; if (typeof t === "object") { i = e.extend(i, t) } else if (e.isFunction(n)) { i = e.extend(i, { over: t, out: n, selector: r }) } else { i = e.extend(i, { over: t, out: t, selector: n }) } var s, o, u, a; var f = function(e) { s = e.pageX;
            o = e.pageY }; var l = function(t, n) { n.hoverIntent_t = clearTimeout(n.hoverIntent_t); if (Math.abs(u - s) + Math.abs(a - o) < i.sensitivity) { e(n).off("mousemove.hoverIntent", f);
                n.hoverIntent_s = 1; return i.over.apply(n, [t]) } else { u = s;
                a = o;
                n.hoverIntent_t = setTimeout(function() { l(t, n) }, i.interval) } }; var c = function(e, t) { t.hoverIntent_t = clearTimeout(t.hoverIntent_t);
            t.hoverIntent_s = 0; return i.out.apply(t, [e]) }; var h = function(t) { var n = jQuery.extend({}, t); var r = this; if (r.hoverIntent_t) { r.hoverIntent_t = clearTimeout(r.hoverIntent_t) } if (t.type == "mouseenter") { u = n.pageX;
                a = n.pageY;
                e(r).on("mousemove.hoverIntent", f); if (r.hoverIntent_s != 1) { r.hoverIntent_t = setTimeout(function() { l(n, r) }, i.interval) } } else { e(r).off("mousemove.hoverIntent", f); if (r.hoverIntent_s == 1) { r.hoverIntent_t = setTimeout(function() { c(n, r) }, i.timeout) } } }; return this.on({ "mouseenter.hoverIntent": h, "mouseleave.hoverIntent": h }, i.selector) } })(jQuery)