				        ...
				        <div class="container">
				            <div class="row">
				                <div class="col span_3">
				                    <a href="/classic/" id="logo"><img alt="Classic-logo" class="stnd default-logo dark-version" src="/classic/assets/images/logo.png"><img alt="Classic-logo" class="retina-logo dark-version" src="/classic/assets/images/logo.png"><img alt="" class="starting-logo default-logo" src="/classic/assets/images/logo.svg"> <img alt="Classic-logo" class="retina-logo starting-logo" src="/classic/assets/images/logo.svg"></a>
				                </div>
				                <!--/span_3-->
				                <div class="col span_9 col_last">
				                    ...
				                    <nav>
				                        ...
				                        <ul class="sf-menu">
				                            <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-5 current_page_item menu-item-6761" id="menu-item-6761">
				                            ...
				                            <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-9688" id="menu-item-9688" style="margin-left:-10px;">
				                                <a href="/classic/overview/">Plant Overview</a>
				                            </li>
				                            <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children sf-with-ul menu-item-6904" id="menu-item-6904">
				                                ...
				                                <ul class="sub-menu">
				                                 <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-6909" id="menu-item-6909">
				                                        <a href="/classic/product/hex/">Hex Bolts</a>
				                                    </li>
				                                     <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-6910" id="menu-item-6910">
				                                        <a href="/classic/product/socket/">Socket Screws</a>
				                                    </li>                                    
				                                    <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-6905" id="menu-item-6905">
				                                        <a href="/classic/product/drywall/"> Drywall Screws</a>
				                                    </li>
				                                       <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-6908" id="menu-item-6908">
				                                        <a href="/classic/product/anchor/">Anchor Bolts</a>
				                                    </li>
				                                     <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-6905" id="menu-item-6905">
				                                        <a href="/classic/product/stud/">Stud Bolts</a>
				                                    </li>
				                                    <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-6907" id="menu-item-6907">
				                                        <a href="/classic/product/rods/">Threaded Rods</a>
				                                    </li>
				                                    <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-6911" id="menu-item-6911">
				                                        <a href="/classic/product/nuts/">Nuts</a>
				                                    </li>
				                                    <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-6923" id="menu-item-6923">
				                                        <a href="/classic/product/washers/">Washers</a>
				                                    </li>
				                                </ul>
				                            </li>
...
var footer_content = `<div id="footer-widgets">
				        <div class="container">
				                ...
				                <div class="col span_4">
				                    <div class="widget widget_text" id="text-2">
				                        ...
				                        <div class="textwidget">
				                            <p>Sector 7, Plot# 64,
				                                <br> Emirates Industrial City, Sajja Area
				                                <br> P.O. Box 5841, Sharjah,
				                                <br> United Arab Emirates (U.A.E)
				                                <br>
				                                <br>
				                            </p>
				                        </div>
                            ...
                            <img class="whatsapp" src="assets/images/linkdin.png">
				                ...
				                <div class="col span_4">
				                    <div class="widget widget_nav_menu" id="nav_menu-1">
				                        <h4>Links</h4>
				                        <div class="menu-footer-container">
				                            <ul class="menu" id="menu-footer">
				                                <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-6805" id="menu-item-6805">
				                                    <a href="/classic/">Home</a>
				                                </li>
				                                <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-6864" id="menu-item-6864">
				                                    <a href="/classic/about/">About us</a>
				                                </li>
				                                <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-6808" id="menu-item-6808">
				                                    <a href="/classic/overview/">Plant Overview</a>
				                                </li>
				                                <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-6765" id="menu-item-6765">
				                                    <a href="/classic/contact/">Contact</a>
				                                </li>
				                            </ul>
				                        </div>
				    ...
				    <div class="row" id="copyright">
				        <div class="container">
				            <div class="col span_5">
				                <p>© 2017 Classic Metallic Sheet Factory LLC
				                    <a href="">
				            ...
				            <div class="col span_3">
				                <p style="visibility:hidden;">
				                    Digital Marketing Agency <a href="http://ibridgedigital.com/" title="Digital Marketing Agency">iBridge Digital                         
				                    </a>
				                </p>                
				            </div>
